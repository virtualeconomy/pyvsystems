...
class Contract(object):
    def __init__(self):
        ...
        self.contract_without_split = ContractBuild('vdds', 1, split=False).contract_byte_str
        self.contract_with_split = ContractBuild('vdds', 1, split=True).contract_byte_str


    def show_contract_function(self, byte_string = '', contract_json = ''):
        print("byte string: ", self.contract_without_split)
