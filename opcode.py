...
class Opcode(object):
    ...
    def opc_load_env_caller(arg):
        ...
        name_list = copy.deepcopy(arg[1])
        function_name = sys._getframe().f_code.co_name
        print(name_list[data[2]] + ' = ' + function_name + '()')
    ...
    def opc_cdbv_set(arg):
        ...
        function_name = sys._getframe().f_code.co_name
        print('cdb.' + state_var[data[2]][1] + ' = ' + function_name + '(' + name_list[data[3]] + ')')
    ...
    def opc_cdbvr_get(arg):
        ...
        state_var = copy.deepcopy(arg[2])
        function_name = sys._getframe().f_code.co_name
        print(name_list[data[3]] + ' = ' + function_name + '(cdb.' + state_var[data[2]][1] + ')')
    ...
    def opc_tdbr_max(arg):
        ...
        name_list = copy.deepcopy(arg[1])
        function_name = sys._getframe().f_code.co_name
        print(name_list[data[3]] + ' = ' + function_name + '(' + name_list[data[2]] + ')')
    ...
    def opc_tdba_transfer(arg):
        ...
        print(function_name, end='')
        print('(' + name_list[data[2]] + ', ' + name_list[data[3]] + ', '
              + name_list[data[4]] + ', ' + name_list[data[5]] + ')')
    ...
    def opc_tdbar_balance(arg):
        ...
        name_list = copy.deepcopy(arg[1])
        function_name = sys._getframe().f_code.co_name
        print(name_list[data[4]] + ' = ' + function_name, end='')
        print('(' + name_list[data[2]] + ', ' + name_list[data[3]] + ')')
